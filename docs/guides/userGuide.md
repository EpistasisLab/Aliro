...
### Installation
1. Download the production zip `pennai-*.zip` from the asset section of the [latest release](https://github.com/EpistasisLab/pennai/releases/latest) (note that this is different from the source code zip file).
2. Unzip the archive
