...
exports.retData = function() {
    ...
    for (group in grouped) {
        ...
        experiments.push({forum:forum,datasets:grouped[group]})
    }
    experiments.push({forum:'all',datasets:datasets})
    //where the magic happens.  order by forum name
    var experiments = experiments.sort(function(a,b) {return (a.forum > b.forum) ? 1 : ((b.forum > a.forum) ? -1 : 0);} )
    return (experiments);
}
