...
// 7 - landscape size
// 8 - random seed
// 9 - comma delimited list of function groups such as Arithmetic,Relational,Logical,Trigonometric,Miscellaneous,Experimental
// 10 - 0 = xml; 1 = inline
// 11 - 0 = serial, 1 = parallel
// 12 - minimum constant value
// 13 - maximum constant value
// 14 - constant step value
// 15 - FileMaskNode file (optional)
public class GPMain extends MainBase {
	public static Logger devLog = Logger.getLogger(GPMain.class.getCanonicalName());
	public static boolean SHOW_EXPERIMENTAL_FUNCTIONS = false;
	...
	public static void main(final String[] args) {
		final String experimentalTest = SyModProperties.get("experimentalTest");
