...
/**
 * Logical AND operator node. Nonzero values are considered to be true. Zero values are considered to be false. Logical return values are
 * 1.0 for true and 0.0 for false.
 */
public class AndNode extends ShortCircuitBinaryOpNode {
