...
/**
 * Greater-than comparison operator node. Return values are 1.0 for true and 0.0 for false.
 */
public class GreaterNode extends BinaryOpNode {
