...
/**
 * Greater-than or equal comparison operator node. Return values are 1.0 for true and 0.0 for false.
 */
public class GreaterEqualNode extends BinaryOpNode {
	...
	public String getOpSymbol() {
		return GreaterEqualNode.symbol;
	}
}
