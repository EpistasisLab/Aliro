...
/**
 * Inequality comparison operator node. Return values are 1.0 for true and 0.0 for false.
 */
public class NotEqualNode extends BinaryOpNode {
