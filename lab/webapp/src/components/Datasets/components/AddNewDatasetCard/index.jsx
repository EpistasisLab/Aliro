      ...
      <Popup
        ...
        trigger={
          ...
          <Button
            ...
            onClick={() => {
              ...
              aiTooglePopup.style.cssText += ";border: 2px solid red;";
              aiTooglePopup.style.cssText +=
                ";animation: blinker 1s linear infinite;";
            }}
          ></Button>
        }
        ...
        onClick={() => {
          if (document.getElementById("addNewPopup") != null) {
            document.getElementById("addNewPopup").style.cssText +=
