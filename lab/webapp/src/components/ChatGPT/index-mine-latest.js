    ...
    async function handleSubmit(e) {
        ...
        fetch(`/chatapi/v1/chats/experiment/${experimentId}`, {
            ...
            .then(data => {
                ...
                // change key name from user to role
                // lastMessage.role = lastMessage.user;
                // change key name from message to content
                // lastMessage.content = lastMessage.message;

                // delete the old key name
                // delete lastMessage.user;
                // delete lastMessage.message;

                // console.log("lastMessage-after", lastMessage);

                // console.log("messages-handlesubmit", messages)
