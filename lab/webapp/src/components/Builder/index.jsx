...
class Builder extends Component {
  ...
  componentDidMount() {
    const { defaultAlgorithms, availableAlgorithms, setCurrentAlgorithm } =
      this.props;
  ...
  handleSubmitExperiment() {
    ...
    console.log("handleSubmitExperiment-this.props", this.props);
    // console.log(
      ...
      <div className="builder-scene">
        <SceneHeader
          header={
            ...
            `${dataset ? `: ${formatDataset(dataset.name)}` : "" + "${}"}`
          }
        />
        <Grid stretched>
          <AlgorithmOptions
        ...
        <Popup
          ...
          onClick={() => {
            if (document.getElementById("submit-experiment-popup") != null) {
              ...
              console.log(
                "submit-experiment-popup",
                localStorage.getItem("submit-experiment-popup")
              );
            }
          }}
        />
...
const mapStateToProps = (state, props) => ({
  ...
  availableAlgorithms: state.preferences.data.algorithms.filter(function (
    algo
  ) {
    ...
    return (
      algo.category ==
      state.datasets.byId[props.location.query.dataset].files[0].prediction_type
    );
  }),
