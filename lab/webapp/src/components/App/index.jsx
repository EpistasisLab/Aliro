...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.tooltipAppFunction_with_setInterval =
      this.tooltipAppFunction_with_setInterval.bind(this);
  ...
  tooltipAppFunction_with_setInterval() {
    ...
    setInterval(() => {
      ...
      if (
        y.length > 0 &&
        document.getElementById("span_test") == null &&
        current_href.includes("upload_") == false
      ) {
  ...
  cleanOtherTooltipFunction() {
    ...
    if (
      document.getElementById("div_tooltip_file_upload") != null &&
      current_href.includes("upload_") == false
    ) {
      // make hidden
      document.getElementById("div_tooltip_file_upload").style.visibility =
        "hidden";
    ...
    if (preferences.isFetching) {
      return (
        <Loader
          ...
          inverted
          size="large"
          content="Retrieving your preferences..."
        />
      );
    }
