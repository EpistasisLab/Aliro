  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        else if (scoreName === "TSNE 2D" ) {
          setPoints(jsonData.X_tsne);
          setLabels(jsonData.y_tsne);
        }

        else if (scoreName === "Cross-Validated Predictions" ) {
          setPoints(jsonData.CVP_2d);
          setLabels(jsonData.CVP_2d_class);
        }
        
        else if (scoreName === "Cross-Validated Residuals" ) {
          setPoints(jsonData.CVR_2d);
          setLabels(jsonData.CVR_2d_class);
        }

        else if (scoreName === "Q-Q Plot for Normalized Residuals" ) {
          setPoints(jsonData.QQNR_2d);
          setLabels(jsonData.QQNR_2d_class);
        }
