        ...
        },
        {
            ...
            "params": {
                "alpha": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto',0.001, 0.01, 0.1, 1.0, 10.0, 100.0]
                    }
                },
                "binarize": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto', 0.0, 0.25, 0.5, 0.75, 1.0]
                    }
                },
                "fit_prior": {
                    "alias": "fit prior",
        ...
        },
        {
            ...
            "params": {
                ...
                "loss": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto',"hinge", "squared_hinge"]
                    }
                },
                "dual": {
                ...
                "tol": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto',0.00001, 0.0001, 0.001, 0.01, 0.1]
                    }
                },
                "C": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto',0.0001, 0.001, 0.01, 0.1, 0.5, 1.0, 10.0, 25.0]
                    }
                }
            }
        },{
            ...
            "params": {
                "loss": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto',"epsilon_insensitive", "squared_epsilon_insensitive"]
                    }
                },
                "dual": {
                    "help": "Select the algorithm to either solve the dual or primal optimization problem. Prefer dual=False when n_samples > n_features.",
                ...
                "epsilon": {
                    ...
                    "ui": {
                        "style": "radio",
                        "choices": ['auto',0.0, 0.0001, 0.001, 0.01, 0.1, 1.0]
                    }
                }
            }
        },
